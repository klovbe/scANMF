...
for (i in 1:10){
  ...
  ## 检查结果
  table(pred_aligned, Zeisel_label_filtered[!retain_mask])
  mean(pred_aligned == Zeisel_label_filtered[!retain_mask])
  result_scCATCH[[i]] <- metric_cal(Zeisel_label_filtered[!retain_mask], pred_aligned)
  ...
  ## 检查结果
  result_sctype[[i]] <- metric_cal(Zeisel_label_filtered[!retain_mask], pred_aligned)
}
...
for (i in 1:10){
  ...
  annotation_labels<-annotation_Zeisel[!retain_mask]
...
save(Zeisel, file = "zeisel_in.RData")
load("zeisel_in.RData")
save(result_scanmf, result_scCATCH, result_scpred, result_sctype, result_sigleR, file = "zeisel_in.RData")
